...
criarAnimal()
// console.log(animal) // Gera erro pois a variavel só pode ser acessada dentro da funçao
...
// Mas mesmo o var não consegue "sair" para fora do escopo da função, sempre usar o let
function ola() {
    var texto = "Olá, mundo!"
}

// console.log(texto) // Gera erro por a var dentro da função não pode ser acessada


// Apenas variáveis declaradas com var são carregadas sempre no começo do código, acima de todo o resto
console.log(nome)
console.log(sobrenome)  // deu erro nesse
